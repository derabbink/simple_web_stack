 ...
 */
public class WebAuthenticationMechanism2 extends AuthenticationMechanism {
	
	public static final String REMEMBER_ME_COOKIE = "acct";
	public static final String SESSION_CREDENTIALS = WebAuthenticationMechanism2.class.getName() + "_SESSION_CREDENTIALS";
	...
	@Inject
	public WebAuthenticationMechanism2(
