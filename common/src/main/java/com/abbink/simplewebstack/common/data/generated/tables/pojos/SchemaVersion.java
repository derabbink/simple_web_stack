...
public class SchemaVersion implements Serializable {
	...
	private static final long serialVersionUID = 265779612;
	...
	public boolean equals(Object obj) {
		...
		if (versionRank == null) {
			if (other.versionRank != null)
				return false;
		}
		else if (!versionRank.equals(other.versionRank))
			return false;
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((versionRank == null) ? 0 : versionRank.hashCode());
