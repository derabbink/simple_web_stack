...
public class FormSecurityManager implements SecurityManager {
	
	private BearerTokenRealm realm;
	private DefaultWebSubjectFactory subjectFactory;
	
	@Inject
	public FormSecurityManager(BearerTokenRealm realm, DefaultWebSubjectFactory subjectFactory) {
		this.realm = realm;
	 ...
	 * This is extremely hacky, but this is on shiro!
	 * @param context must be a WebSessionContext instance.
