 ...
 */
public class OptionalWebAuthenticationMechanism2 extends AuthenticationMechanism {
	...
	@Inject
	public OptionalWebAuthenticationMechanism2(
	...
	static ContainerRequest doFilter(
		...
		try {
			return WebAuthenticationMechanism2.doFilter(
				request,
				securityManager,
				servletRequest,
				servletResponse
		...
		return AnonymousAuthenticationMechanism2.doFilter(
			request,
			securityManager,
			servletRequest,
			servletResponse
